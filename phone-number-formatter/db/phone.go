...
//Phone number model in the database
type Phone struct {
	ID int
	Number string
}
...
//resets database
func Reset(driverName, dataSource string, dbName string) error {
	db, err := sql.Open(driverName, dataSource)
...
func createDB(db *sql.DB, name string) error {
	//You typically don't do this due to risk of SQL injection but it's okay in the context of this tutorial
